...
data3 =[{'genap':2,'ganjil':1},
        ...
        {'ganjil':5,'genap':6}]
#tabs
tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(["Tab 1", "Tab 2", "Tab3", "Tab4", "Tab5", "About Me"])
with tab1:
	st.header("Tab 1")
...
with tab6:
	st.header("Asifa Ahmad")
	st.write("Hi everyone, people around me call me sifa, but you can call me shiva.")
	st.image("https://wallpapercave.com/wp/wp10097101.jpg")
